        ...
        setContent {
            FINALTheme {
                Surface(
                    ...
                    // Function to start the background tracking service
                    fun startLocationService() {
                        val intent = Intent(context, AudioPlayerService::class.java).apply {
                            action = AudioPlayerService.ACTION_START_TRACKING
                        }
                    ...
                    val backgroundPermissionLauncher = rememberLauncherForActivityResult(
                        ...
                        if (isGranted) {
                            ...
                            // Try starting service if we have background now
                            if (hasAllPermissions) startLocationService()
                        } else {
                            Toast.makeText(context, "Background location needed for Story Discovery", Toast.LENGTH_LONG).show()
                        }
                    }
                    ...
                    val permissionLauncher = rememberLauncherForActivityResult(
                        ...
                        if (locationGranted) {
                            ...
                            // Start the Service logic explicitly here
                    ...
                    AppNavigation(startIntent = intent, locationViewModel = locationViewModel, storyViewModel = storyViewModel)
                }
            }
        }
    }
